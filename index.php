...
<div class="row">
    ...
    <div class="student-add-form form-group col-sm-4 col-sm-push-8">
        ...
        <button type="button" class="btn btn-success button-add">Add</button>
        <button type="button" class="btn btn-default button-cancel" onclick="cancelClicked()">Cancel</button>
        <button type="button" class="btn btn-default button-db">Populate From DB</button>
    </div>
